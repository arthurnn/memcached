...
_wrap_MemcachedSt_last_server_key_set(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_memcached_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "last_server_key" "', argument " "1"" of type '" "struct memcached_st *""'"); 
  }
  arg1 = (struct memcached_st *)(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "last_server_key" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
...
_wrap_memcached_get_len(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_memcached_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "memcached_get_len" "', argument " "1"" of type '" "memcached_st *""'"); 
  }
  arg1 = (memcached_st *)(argp1);
  {
    arg2 = StringValuePtr(argv[1]);
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "memcached_get_len" "', argument " "4"" of type '" "uint32_t""'"); 
    }  
    if (!argp4) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "memcached_get_len" "', argument " "4"" of type '" "uint32_t""'");
    } else {
      arg4 = *((uint32_t *)(argp4));
    }
  }
...
_wrap_memcached_mget_len(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_memcached_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "memcached_mget_len" "', argument " "1"" of type '" "memcached_st *""'"); 
  }
  arg1 = (memcached_st *)(argp1);
  {
    int i;
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "memcached_mget_len" "', argument " "5"" of type '" "uint32_t""'"); 
    }  
    if (!argp5) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "memcached_mget_len" "', argument " "5"" of type '" "uint32_t""'");
    } else {
      arg5 = *((uint32_t *)(argp5));
    }
  }
...
_wrap_memcached_get_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res6)) {
      SWIG_exception_fail(SWIG_ArgError(res6), "in method '" "memcached_get_by_key" "', argument " "6"" of type '" "uint32_t""'"); 
    }  
    if (!argp6) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "memcached_get_by_key" "', argument " "6"" of type '" "uint32_t""'");
    } else {
      arg6 = *((uint32_t *)(argp6));
    }
  }
...
_wrap_memcached_mget_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res7)) {
      SWIG_exception_fail(SWIG_ArgError(res7), "in method '" "memcached_mget_by_key" "', argument " "7"" of type '" "uint32_t""'"); 
    }  
    if (!argp7) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "memcached_mget_by_key" "', argument " "7"" of type '" "uint32_t""'");
    } else {
      arg7 = *((uint32_t *)(argp7));
    }
  }
...
_wrap_memcached_get_from_last(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_memcached_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "memcached_get_from_last" "', argument " "1"" of type '" "memcached_st *""'"); 
  }
  arg1 = (memcached_st *)(argp1);
  {
    arg2 = StringValuePtr(argv[1]);
...
_wrap_MemcachedServerSt_cached_server_error_set(int argc, VALUE *argv, VALUE self) {
  ...
  if (arg2) {
    size_t size = strlen(arg2) + 1;
    arg1->cached_server_error = (char *)memcpy((char *)malloc((size)*sizeof(char)), arg2, sizeof(char)*(size));
  } else {
...
_wrap_memcached_get_from_last_rvalue(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_memcached_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "memcached_get_from_last_rvalue" "', argument " "1"" of type '" "memcached_st *""'"); 
  }
  arg1 = (memcached_st *)(argp1);
  {
    arg2 = StringValuePtr(argv[1]);
...
SWIGEXPORT void Init_rlibmemcached(void) {
  ...
  rb_define_method(cMemcachedSt.klass, "last_server_key=", _wrap_MemcachedSt_last_server_key_set, -1);
  rb_define_method(cMemcachedSt.klass, "last_server_key", _wrap_MemcachedSt_last_server_key_get, -1);
  cMemcachedSt.mark = 0;
