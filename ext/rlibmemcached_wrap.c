...
_wrap_MemcachedStatSt_limit_maxbytes_set(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (struct memcached_stat_st *)(argp1);
  {
    res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_uint32_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "uint32_t","limit_maxbytes", 2, argv[0] )); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "uint32_t","limit_maxbytes", 2, argv[0]));
    } else {
      arg2 = *((uint32_t *)(argp2));
    }
  }
...
_wrap_MemcachedStringSt_is_allocated_set(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_memcached_string_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "struct memcached_string_st *","is_allocated", 1, self )); 
  }
  arg1 = (struct memcached_string_st *)(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
_wrap_MemcachedStringSt_block_size_set(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_memcached_string_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "struct memcached_string_st *","block_size", 1, self )); 
  }
  arg1 = (struct memcached_string_st *)(argp1);
  ecode2 = SWIG_AsVal_size_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "size_t","block_size", 2, argv[0] ));
  } 
  arg2 = (size_t)(val2);
...
_wrap_MemcachedResultSt_cas_set(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (struct memcached_result_st *)(argp1);
  {
    res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_uint64_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "uint64_t","cas", 2, argv[0] )); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "uint64_t","cas", 2, argv[0]));
    } else {
      arg2 = *((uint64_t *)(argp2));
    }
  }
...
_wrap_MemcachedSt_wheel_set(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "unsigned int [1024]","wheel", 2, argv[0] )); 
  } 
...
_wrap_MemcachedSt_on_clone_set(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (struct memcached_st *)(argp1);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), Ruby_Format_TypeError( "", "memcached_clone_func","on_clone", 2, argv[0] )); 
    }
  }
...
_wrap_MemcachedSt_on_cleanup_set(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (struct memcached_st *)(argp1);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), Ruby_Format_TypeError( "", "memcached_cleanup_func","on_cleanup", 2, argv[0] )); 
    }
  }
...
_wrap_MemcachedSt_call_free_set(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (struct memcached_st *)(argp1);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), Ruby_Format_TypeError( "", "memcached_free_function","call_free", 2, argv[0] )); 
    }
  }
...
_wrap_MemcachedSt_call_malloc_set(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (struct memcached_st *)(argp1);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), Ruby_Format_TypeError( "", "memcached_malloc_function","call_malloc", 2, argv[0] )); 
    }
  }
...
_wrap_MemcachedSt_call_realloc_set(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (struct memcached_st *)(argp1);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), Ruby_Format_TypeError( "", "memcached_realloc_function","call_realloc", 2, argv[0] )); 
    }
  }
...
_wrap_memcached_cas(int argc, VALUE *argv, VALUE self) {
  ...
  arg7 = (uint32_t)(val7);
  {
    ...
    if (!SWIG_IsOK(res8)) {
      SWIG_exception_fail(SWIG_ArgError(res8), Ruby_Format_TypeError( "", "uint64_t","memcached_cas", 8, argv[5] )); 
    }  
    if (!argp8) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "uint64_t","memcached_cas", 8, argv[5]));
    } else {
      arg8 = *((uint64_t *)(argp8));
    }
  }
...
_wrap_memcached_mget(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char **","memcached_mget", 2, argv[1] )); 
  }
  arg2 = (char **)(argp2);
  res3 = SWIG_ConvertPtr(argv[2], &argp3,SWIGTYPE_p_size_t, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "size_t *","memcached_mget", 3, argv[2] )); 
  }
  arg3 = (size_t *)(argp3);
  ecode4 = SWIG_AsVal_unsigned_SS_int(argv[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), Ruby_Format_TypeError( "", "unsigned int","memcached_mget", 4, argv[3] ));
  } 
  arg4 = (unsigned int)(val4);
...
_wrap_memcached_get_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","memcached_get_by_key", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
...
_wrap_memcached_mget_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "char **","memcached_mget_by_key", 4, argv[3] )); 
  }
  arg4 = (char **)(argp4);
  res5 = SWIG_ConvertPtr(argv[4], &argp5,SWIGTYPE_p_size_t, 0 |  0 );
  if (!SWIG_IsOK(res5)) {
    SWIG_exception_fail(SWIG_ArgError(res5), Ruby_Format_TypeError( "", "size_t *","memcached_mget_by_key", 5, argv[4] )); 
  }
  arg5 = (size_t *)(argp5);
  ecode6 = SWIG_AsVal_unsigned_SS_int(argv[5], &val6);
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), Ruby_Format_TypeError( "", "unsigned int","memcached_mget_by_key", 6, argv[5] ));
  } 
...
_wrap_memcached_set_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","memcached_set_by_key", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  ecode3 = SWIG_AsVal_size_t(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
...
_wrap_memcached_add_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","memcached_add_by_key", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  ecode3 = SWIG_AsVal_size_t(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
...
_wrap_memcached_replace_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","memcached_replace_by_key", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  ecode3 = SWIG_AsVal_size_t(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
...
_wrap_memcached_prepend_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","memcached_prepend_by_key", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  ecode3 = SWIG_AsVal_size_t(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
...
_wrap_memcached_append_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","memcached_append_by_key", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  ecode3 = SWIG_AsVal_size_t(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
...
_wrap_memcached_cas_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","memcached_cas_by_key", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  ecode3 = SWIG_AsVal_size_t(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
  ...
  arg9 = (uint32_t)(val9);
  {
    ...
    if (!SWIG_IsOK(res10)) {
      SWIG_exception_fail(SWIG_ArgError(res10), Ruby_Format_TypeError( "", "uint64_t","memcached_cas_by_key", 10, argv[7] )); 
    }  
    if (!argp10) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "uint64_t","memcached_cas_by_key", 10, argv[7]));
    } else {
...
_wrap_memcached_delete_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char *","memcached_delete_by_key", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  ecode3 = SWIG_AsVal_size_t(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
...
_wrap_memcached_fetch_execute(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "unsigned int (*[])(memcached_st *,memcached_result_st *,void *)","memcached_fetch_execute", 2, argv[1] )); 
  } 
...
_wrap_memcached_get_ruby_string(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_memcached_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "memcached_st *","memcached_get_ruby_string", 1, argv[0] )); 
  }
  arg1 = (memcached_st *)(argp1);
  {
    arg2 = STR2CSTR(argv[1]);
...
SWIGINTERN VALUE
_wrap_memcached_stat_get_ruby_value(int argc, VALUE *argv, VALUE self) {
  memcached_st *arg1 = (memcached_st *) 0 ;
  memcached_stat_st *arg2 = (memcached_stat_st *) 0 ;
  char *arg3 = (char *) 0 ;
  memcached_return *arg4 = (memcached_return *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_memcached_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "memcached_st *","memcached_stat_get_ruby_value", 1, argv[0] )); 
  }
  arg1 = (memcached_st *)(argp1);
  res2 = SWIG_ConvertPtr(argv[1], &argp2,SWIGTYPE_p_memcached_stat_st, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "memcached_stat_st *","memcached_stat_get_ruby_value", 2, argv[1] )); 
  }
  arg2 = (memcached_stat_st *)(argp2);
  res3 = SWIG_AsCharPtrAndSize(argv[2], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "char *","memcached_stat_get_ruby_value", 3, argv[2] ));
  }
  arg3 = (char *)(buf3);
  result = (VALUE)memcached_stat_get_ruby_value(arg1,arg2,arg3,arg4);
  vresult = result;
  if (SWIG_IsTmpObj(res4)) {
    vresult = SWIG_Ruby_AppendOutput(vresult, SWIG_From_unsigned_SS_short((*arg4)));
  } else {
...
static swig_type_info _swigt__p_f_p_struct_memcached_st_p_void__void = {"_p_f_p_struct_memcached_st_p_void__void", "memcached_free_function|void (*)(struct memcached_st *,void *)", 0, 0, (void*)0, 0};
...
SWIGEXPORT void Init_rlibmemcached(void) {
  ...
  rb_define_module_function(mRlibmemcached, "memcached_stat_get_ruby_value", _wrap_memcached_stat_get_ruby_value, -1);
