...
_wrap_memcached_server_add_udp(int argc, VALUE *argv, VALUE self) {
  ...
  ecode4 = SWIG_AsVal_unsigned_SS_int(argv[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), Ruby_Format_TypeError( "", "unsigned int","memcached_server_add_udp", 4, argv[3] ));
  } 
  arg4 = (unsigned int)(val4);
  result = (memcached_return)memcached_server_add_udp(arg1,(char const *)arg2,arg3,arg4);
  vresult = SWIG_From_int((int)(result));
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
  return vresult;
fail:
...
_wrap_memcached_server_add_unix_socket(int argc, VALUE *argv, VALUE self) {
  ...
  ecode3 = SWIG_AsVal_unsigned_SS_int(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "unsigned int","memcached_server_add_unix_socket", 3, argv[2] ));
  } 
  arg3 = (unsigned int)(val3);
  result = (memcached_return)memcached_server_add_unix_socket(arg1,(char const *)arg2,arg3);
  vresult = SWIG_From_int((int)(result));
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
  return vresult;
fail:
...
_wrap_memcached_server_add(int argc, VALUE *argv, VALUE self) {
  ...
  ecode4 = SWIG_AsVal_unsigned_SS_int(argv[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), Ruby_Format_TypeError( "", "unsigned int","memcached_server_add", 4, argv[3] ));
  } 
  arg4 = (unsigned int)(val4);
  result = (memcached_return)memcached_server_add(arg1,(char const *)arg2,arg3,arg4);
  vresult = SWIG_From_int((int)(result));
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
  return vresult;
fail:
...
SWIGINTERN VALUE
_wrap_memcached_server_list_append_full(int argc, VALUE *argv, VALUE self) {
  memcached_server_st *arg1 = (memcached_server_st *) 0 ;
  char *arg2 = (char *) 0 ;
  unsigned int arg3 ;
  unsigned int arg4 ;
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_memcached_server_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "memcached_server_st *","memcached_server_list_append_full", 1, argv[0] )); 
  }
  arg1 = (memcached_server_st *)(argp1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","memcached_server_list_append_full", 2, argv[1] ));
  }
  arg2 = (char *)(buf2);
  ecode3 = SWIG_AsVal_unsigned_SS_int(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "unsigned int","memcached_server_list_append_full", 3, argv[2] ));
  } 
  arg3 = (unsigned int)(val3);
  ecode4 = SWIG_AsVal_unsigned_SS_int(argv[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), Ruby_Format_TypeError( "", "unsigned int","memcached_server_list_append_full", 4, argv[3] ));
  } 
  arg4 = (unsigned int)(val4);
  result = (memcached_server_st *)memcached_server_list_append_full(arg1,(char const *)arg2,arg3,arg4,arg5);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_memcached_server_st, 0 |  0 );
  if (SWIG_IsTmpObj(res5)) {
...
SWIGEXPORT void Init_rlibmemcached(void) {
  ...
  rb_define_module_function(mRlibmemcached, "memcached_server_list_append_full", _wrap_memcached_server_list_append_full, -1);
