...
_wrap_memcached_mget_execute(int argc, VALUE *argv, VALUE self) {
  ...
  arg4 = (size_t)(val4);
  res5 = SWIG_ConvertPtr(argv[4], &argp5,SWIGTYPE_p_memcached_execute_function, 0 |  0 );
  if (!SWIG_IsOK(res5)) {
    SWIG_exception_fail(SWIG_ArgError(res5), Ruby_Format_TypeError( "", "memcached_execute_function *","memcached_mget_execute", 5, argv[4] )); 
  }
  ...
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), Ruby_Format_TypeError( "", "unsigned int","memcached_mget_execute", 7, argv[6] ));
  } 
...
_wrap_memcached_mget_execute_by_key(int argc, VALUE *argv, VALUE self) {
  ...
  arg6 = (size_t)(val6);
  res7 = SWIG_ConvertPtr(argv[6], &argp7,SWIGTYPE_p_memcached_execute_function, 0 |  0 );
  if (!SWIG_IsOK(res7)) {
    SWIG_exception_fail(SWIG_ArgError(res7), Ruby_Format_TypeError( "", "memcached_execute_function *","memcached_mget_execute_by_key", 7, argv[6] )); 
  }
  ...
  if (!SWIG_IsOK(ecode9)) {
    SWIG_exception_fail(SWIG_ArgError(ecode9), Ruby_Format_TypeError( "", "unsigned int","memcached_mget_execute_by_key", 9, argv[8] ));
  } 
...
_wrap_memcached_server_get_last_disconnect(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_memcached_st, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "memcached_st *","memcached_server_get_last_disconnect", 1, argv[0] )); 
  }
  arg1 = (memcached_st *)(argp1);
